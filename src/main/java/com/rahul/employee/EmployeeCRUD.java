...
public class EmployeeCRUD {
	...
	public static void main(String args[]) {
		...
		case 1:
			...
			@SuppressWarnings("deprecation") Criteria cr = session.createCriteria(Employee.class);
			@SuppressWarnings("unchecked") List<Employee> list = cr.list();
		...
		case 2:
			...
			Employee employee1 = new Employee(eno1,ename1,esal1,new Laptop(lcode1));
		...
		case 3:
			...
			Employee e=session.get(Employee.class,eno2);
			e.setEname(ename2);
			e.setSal(esal2);
		...
		case 4:
			...
			System.out.println("enter eno");
			int eno3 = sc.nextInt();
			Employee e1=session.get(Employee.class,eno3);
